...
let s:menus.thinkvim.file_candidates = [
  \   ['🐠 MainVimrc          settings: vimrc               🔹', $VIMPATH.'/config/vimrc'],
  \   ['🐠 Initial            settings: init.vim            🔹', $VIMPATH.'/config/init.vim'],
  \   ['🐠 General            settings: general.vim         🔹', $VIMPATH.'/config/general.vim'],
  \   ['🐠 DeinConfig         settings: deinrc.vim          🔹', $VIMPATH.'/config/deinrc.vim'],
  \   ['🐠 FileTypes          settings: filetype.vim        🔹', $VIMPATH.'/config/filetype.vim'],
  \   ['🐠 Installed       LoadPlugins: plugins.yaml        🔹', $VIMPATH.'/config/dein/plugins.yaml'],
  \   ['🐠 Installed      LocalPlugins: local_plugins.yaml  🔹', $VIMPATH.'/config/dein/local_plugins.yaml'],
  \   ['🐠 Global   Key    Vimmappings: mappings.vim        🔹', $VIMPATH.'/config/mappings.vim'],
  \   ['🐠 Global   Key Pluginmappings: Pluginmappings      🔹', $VIMPATH.'/config/plugins/allkey.vim'],
  \ ]
